...
# This part perhaps does not work because an unzip funtion is still required

if(local == 1){
  subj1 <- read_csv("D:/Projects/2022_MANUSCRITOS/2020_SUMMA_BIOL/Notebooks_Programs/MHEALTHDATASET/subj1.csv")
  subj2 <- read_csv("D:/Projects/2022_MANUSCRITOS/2020_SUMMA_BIOL/Notebooks_Programs/MHEALTHDATASET/subj2.csv")
  subj3 <- read_csv("D:/Projects/2022_MANUSCRITOS/2020_SUMMA_BIOL/Notebooks_Programs/MHEALTHDATASET/subj3.csv")
  subj4 <- read_csv("D:/Projects/2022_MANUSCRITOS/2020_SUMMA_BIOL/Notebooks_Programs/MHEALTHDATASET/subj4.csv")
  subj5 <- read_csv("D:/Projects/2022_MANUSCRITOS/2020_SUMMA_BIOL/Notebooks_Programs/MHEALTHDATASET/subj5.csv")
  subj6 <- read_csv("D:/Projects/2022_MANUSCRITOS/2020_SUMMA_BIOL/Notebooks_Programs/MHEALTHDATASET/subj6.csv")
  subj7 <- read_csv("D:/Projects/2022_MANUSCRITOS/2020_SUMMA_BIOL/Notebooks_Programs/MHEALTHDATASET/subj7.csv")
  subj8 <- read_csv("D:/Projects/2021_MANUSCRITOS/2020_SUMMA_BIOL/Notebooks_Programs/MHEALTHDATASET/subj8.csv")
}
...
# Synthetic data: different combination of semi-periodic timeseries - No real coupled model
if(local == 3){
  synthetic <- read_table2("D:/Projects/2021_MANUSCRITOS/2020_SUMMA_BIOL/Notebooks_Programs/Synthetic_Data/synthetic.txt")
...
NumberPatients <- 8
```
If required, export downloaded data into a local file
* 1 is for export
* 0 is for non-export
...
- $s_pa = {1,2,3} $ is the list number where the acceleration measured in the chest in the corresponing axis is mesured (corresponds to column 1 to 3)
- s_pb is the electrogardiogram signal, lead 1 (corresponds to column 4)
...
* Each list ist is constructed as a correlation over different periods of time
* This construction is the relevant part for the causal analysis on each organism/individual
...
* The coomputation takes place over all the defined time periods
...
* Bith (diagram[,3]) (Birth event in the persistence bar diagram)
...
* Computation of the Ph_S entropy -
...
In the next step we perform the computation of entropy for the final estimation of the diagram to asess the observability of the system. Observe that we perform this measument for the individual i respect other individuals j:  
...
if(axis == 1){
  write.csv(Obs, file="D:/Projects/2022_MANUSCRITOS/2020_SUMMA_BIOL/Notebooks_Programs/Results/Phy_S_Diag_Mhealt_x.csv")
}
if(axis == 2){
  write.csv(Obs, file="D:/Projects/2022_MANUSCRITOS/2020_SUMMA_BIOL/Notebooks_Programs/Results/Phy_S_Diag_Mhealt_y.csv")
}
if(axis == 3){
...
Since the final result is essentially a distribution of dots representing the observability of the system, then we also define a box-plot to represent this data as a [double boxplot](https://www.r-bloggers.com/2013/11/double-box-plot-package-boxplotdbl-1-2-0-released/)
